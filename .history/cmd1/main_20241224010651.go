...
func main() {
	...
	orderHandler := handlers.NewCartHandler(*cartUseCase)
	...
	server := api.NewServerHTTP(userHandler, authHandler, adminHandler, categoryHandler, productHandler, cartHandler)
