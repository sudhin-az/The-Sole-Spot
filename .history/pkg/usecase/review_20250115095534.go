...
func (r *ReviewUseCase) AddReview(userID int, productID uint, Rating float64, Comment string) (models.ReviewResponse, error) {
	...
	reviews, err := r.repo.AddReview(userID, productID, Rating, Comment)
	if err != nil {
		return models.ReviewResponse{}, err
	}
