...
func (uc *UserUseCase) ForgotPassword(userID int, input models.ForgotPassword) (models.User, error) {
	...
	if err := uc.userRepo.ForgotPassword(userID, string(hashedPassword)); err != nil {
