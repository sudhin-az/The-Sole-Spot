...
func AdminRoutes(router *gin.RouterGroup, adminHandler *handlers.AdminHandler, categoryHandler *handlers.CategoryHandler, productHandler *handlers.ProductHandler, orderHandler *handlers.OrderHandler) {
	...
	{
		orders.GET("/listorders", orderHandler.ListOrders)
		orders.PATCH("cancelorders", orderHandler.CancelOrders)
	}
}
