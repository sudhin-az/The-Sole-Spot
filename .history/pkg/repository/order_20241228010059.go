...
func (o *OrderRepository) FetchCartItem(userID int) (models.ProductResponse, error) {
	var cartItems models.ProductResponse
	err := o.DB.Raw("select * from carts where user_id = ?", userID).Scan(&cartItems).Error
	if err != nil {
