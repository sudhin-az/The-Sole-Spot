...
func (o *OrderRepository) CreateOrderItems(orderItems []domain.OrderItem) error {
	result := o.DB.Create(&orderItems)
	return result.Error
}
func (o *OrderRepository) FetchOrderWithItems(orderID int64) (models.CombinedOrderDetails, error) {
	var order models.CombinedOrderDetails
