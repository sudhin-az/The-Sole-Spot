...
type Order struct {
	...
	CouponID        *int      `json:"coupon_id,omitempty" gorm:"column:coupon_id"` // Optional field
	...
	PaymentMethodID *int      `json:"payment_method_id,omitempty" gorm:"column:payment_method_id"` // Optional field
